    ...
    >
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          ...
          rounded-2xl overflow-hidden shadow-2x1 bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20 border border-[#1cd8d2]/25"
          ...
          <div className="flex-1 flex flex-col justify-center md:text-left">
            <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2] to-[#00bf8f] to-[#1cd8d2]">
              Gitansh Pise
            </h2>
          ...
          Full Stack Developer
            ...
            <p className="mt-4 text-base sm:text-lg  text-gray-300 text base leading-relaxed md:max-w-2xl md:max-w-3xl">
            I build experiences that feel futuristic,
systems that think, scale, and adapt.
Fueled by curiosity, caffeine, and creativity —
turning ambitious ideas into reality through code.
            </p>
